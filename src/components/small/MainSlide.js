          ...
          <div className="carousel-inner">
            <div className="carousel-item active border-0">
              <div className="d-flex w-90 mt-md-5">
                <div className="row mx-auto col-md-9 mt-3">
                  <div className="col-md-6 ml-md-5 mx-auto text-left pt-md-5">
              ...
              <div className="row mx-auto col-md-9 align-items-center mb-4 align-left btns-rdm-ply">
                <div className="col-10 col-md-9 mx-auto d-flex align-items-center">
                  <button
                    className="btn-rdm-grd p-2 "
                    onClick={more}
                    id="parachange"
                  >
                    Read More
